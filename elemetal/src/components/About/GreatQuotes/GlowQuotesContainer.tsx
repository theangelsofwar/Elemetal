...
const someQuotes=['If you don\'t like how the table is set, flip that table over -House of Cards','To Write Philosophy, meaning, create Art through Technology, for that is what life is about', '<h4>Destruction<h4> is a <i>form</i> of <b> Creation <b> <br></br> -Donnie Darko', 
