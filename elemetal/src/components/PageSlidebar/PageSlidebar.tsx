...
const PageSlidebar = (): JSX.Element => {
  ...
  return (
    ...
    <Slider pageWrapId={'page-wrap'} outerContainerId={'carraway'} customBurgerIcon={ <img src={require("../../images/angelsOfWar.png")} alt=""/> }>
      ...
      <a id='contactinqueries' className='menu-item' href='/contactInqueries'> <span className='gradient'>  </span>  <TransitionLink to='/contactInqueries' activeClass='active' className='transition-link' exit={{ zIndex: 2 }} > Query </TransitionLink> </a>
